...
class MysqlFunctionAlias {
    ...
    companion object {
        ...
        fun createStDistanceSphereAlias(): String {
            return """CREATE ALIAS IF NOT EXISTS ST_DISTANCE_SPHERE FOR "kr.disdong.spring.db.sql.function.store.MysqlFunctionAlias.ST_DISTANCE_SPHERE""""
        }

        fun createPointAlias(): String {
            return """CREATE ALIAS IF NOT EXISTS POINT FOR "kr.disdong.spring.db.sql.function.store.MysqlFunctionAlias.POINT""""
        }
    }
}
